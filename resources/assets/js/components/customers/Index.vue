<template >     
      <div class="content-wrapper">
        ...
        <div class="d-flex div-navegate-page">    
          ...
          <p class="hover-cursor">&nbsp;clientes</p>          
        </div>        
        <div class="row div-title-module">
          <div class="col-md-10">
            <h2>Gestión de registro de clientes</h2>          
          </div>
          <div class="col-md-2">
        ...
        <v-client-table  class="index-table" :data="tableData" :columns="columns" :options="options">
          ...
          <span slot="actions" slot-scope="props">
            ...
            <router-link v-if ="!props.row.deleted_at" :to="'/customers/edit/'+props.row.id">
            ...
            <img v-if ="!props.row.deleted_at"  src="/intranet/img/icons/on.png" class="hover-cursor icons-action-row-form" title="presione para desactivar el registro" @click="changeStatus(props.row.id, '/customer-status', '/customers-table-list')" >
            <img v-else src="/intranet/img/icons/off.png" class="hover-cursor icons-action-row-form" title="presione para activar el registro"  @click="changeStatus(props.row.id, '/customer-status', '/customers-table-list')">
          </span>                                                     
        </v-client-table>   
      </div>          
</template>
<script>
    ...
    export default {
      ...
      created () {
        this.getDataTable('/customers-table-list')
