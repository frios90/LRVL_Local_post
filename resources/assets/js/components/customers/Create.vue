          ...
          <form class="form-basic">       
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <span class="mdi mdi-alert-circle circle-info" title="Ingrese el rut del cliente"></span>
                    <input type="text" class="form-control form-control-sm" v-model="customer.rut" name="rut" v-rut:live maxlength="12" >  
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control form-control-sm" v-model="customer.name" maxlength="50" name="name" >
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control form-control-sm" v-model="customer.email" maxlength="50" name="email" >       
