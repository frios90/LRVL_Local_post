<template >
   <div class="content-wrapper">
      ...
      <div class="row div-title-module">
        <div class="col-md-10">
          <h2>Geolocalización del proveedor [ {{ provider.name }} ]</h2>         
        </div>
        <div class="col-md-2">
        ...
        <div class="card-body">  
          ...
          <div class="">
            <table class="table">
              ...
              <tbody>
                <tr v-for="(location, key_location) of provider.locations" :key="key_location">
    ...
    methods: {  
      ...
      initMarker () { 
        ...
        if (this.provider.locations) {
            this.provider.locations.forEach(function (val, index) {
      ...
      getData () {
        var self = this
        this.$http.get('/get-provider', {params: {id: self.provider.id}})
        .then(response => {                    
          self.provider.name       = response.body.name
          self.provider.locations  = response.body.provider_geolocation 
      ...
      postStore () {
        ...
        this.$http.post('/provider-geolocation-store', send)
        .then(response => {
