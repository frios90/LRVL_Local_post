<template >
   <div class="content-wrapper">
      ...
      <div class="row div-title-module">
        <div class="col-md-10">
          <h2>Editar datos de la empresa [ {{ company.name }} ]</h2>         
        </div>
        <div class="col-md-2">
           ...
           <form action="" class="form-basic">                    
              <div class="row">
                  <div class="form-group col-md-4">
                      ...
                      <input type="text" class="form-control form-control-sm  mantainer-input" v-model="company.rut" name="rut" readonly>
              ...
              <div class="row">
                ...
                <div class="form-group col-md-4">
                  ...
                  <div class="form-group col-md-4">
                      <label for="">Dirección <i class="mdi mdi-alert-circle circle-info" title="Ingrese la dirección en la que se ubica la empresa" maxlength="50"></i></label>
    ...
    mixins: [Util],
      ...
      methods: {  
        ...
        getData () {
          ...
          .then(response => {  
            self.company.rut = response.body.rut                  
            self.company.name = response.body.name
            self.company.email = response.body.email
            self.company.contact = response.body.contact
            self.company.phone = response.body.phone
            self.company.address = response.body.address
            self.company.region_id = response.body.region_id
            self.getCommunes()
            self.company.commune_id = response.body.commune_id
            self.loader = false
          }, response => {      
             self.loader = false           
